...
def supervised_mos(logger, args, num_of_clusters, ood_path, id_path, device):
    ...
    result_path = "results/mos_models/seed_" + str(args.seed)
...
def main(args):
    ...
    supervised_mos(logger, args, args.num_of_clusters, args.ood_feats_path, args.id_feats_path, device)
