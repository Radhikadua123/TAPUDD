...
for method in ["Gram"]:
    ...
    for seed in [0, 1, 2, 3, 4, 663, 1458, 1708, 1955, 7130]:
        ...
        for var in adjust_scale:
            ...
            with open(f'/home/radhika/TAPUDD/binary_classification/gram_baseline/results/logs/lastlayer/ood_scores/NAS_DETECTION_{adjust_type}_test_{method}/seed_{seed}/{var}/ood_scores.log') as f:
                lines = f.readlines()
