...
for ((num_samples=1281167; num_samples<=num_samples_for_fitting_model; num_samples += 200000)); do
    for OUT_DATA in iNaturalist dtd Places SUN; do
        ...
        --ood_scores_path /home/radhika/mos1/checkpoints/test_log/${name_base_models}/num_samples${num_samples} \
        --id_scores_path /home/radhika/mos1/checkpoints/test_log/${name_base_models}/num_samples${num_samples} \
        --top ${top} \
        --best ${best} \
        --average ${average} \
        --extremes ${extremes} \
